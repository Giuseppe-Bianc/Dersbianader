...
// configuration step. It creates a namespace called `Dersbianader`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Dersbianader::cmake::project_name, Dersbianader::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Dersbianader::cmake::project_version);
      return EXIT_SUCCESS;
    }
